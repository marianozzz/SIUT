...
<div class="container mt-4">
    <h1 class="mb-4 text-center">Editar Perfil - Alumno</h1>

    <form action="{{ route('alumno.perfil.update', auth()->id()) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('alumno.perfil.index') }}" class="btn btn-secondary">Cancelar</a>
    </form>
</div>
@endsection
